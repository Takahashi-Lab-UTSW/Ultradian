path<-"C:/Users/SHU/Documents/Doc/UltradianCycle/UC-Plots/All_Figs/Figs_B/Fig2/GJ_blocker/"
...
# # Add rectangles
p<- p + annotate("rect", xmin=1.15, xmax=4, ymin=-0.05 , ymax=-0.025, alpha=0.25, size=0, color="black", fill="black")
# # Add segments
