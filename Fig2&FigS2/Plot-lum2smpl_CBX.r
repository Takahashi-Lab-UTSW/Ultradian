path<-"C:/Users/SHU/Documents/Doc/UltradianCycle/UC-Plots/All_Figs/Figs_C/Fig2/CBX/"
...
# # Add rectangles
p<- p + annotate("rect", xmin=1.15, xmax=2.15, ymin=0.5 , ymax=0.53, alpha=0.25, size=0, color="black", fill="black")
# # Add segments
