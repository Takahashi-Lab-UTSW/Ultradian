path<-"C:/Users/SHU/Documents/Doc/UltradianCycle/UC-Plots/All_Figs/Figs_C/Fig2/shCx/"
...
if (n==1){
  p<-p + theme(legend.position="none") + 
    annotate("text", label=samp.shCx, color="black", x=max(dat1$Days), y=max(dat1$Luminescence), hjust=1, vjust=0.75, size=2.8) # label/legend for single sample
}
assign(plotname,p)
