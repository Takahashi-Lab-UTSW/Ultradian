path<-"C:/Users/SHU/Documents/Doc/UltradianCycle/UC-Plots/All_Figs/Figs_B/Fig4/BAPTA-AM/"

setwd(paste(path))

# folders = list.dirs('.', full.names=FALSE, recursive=FALSE)
# read csv data exported from Lumicycle Analysis
samp.BAPTAAM<-c("Vehicle", "BAPTA-AM 10uM", "BAPTA-AM 30uM")  ##################################### provide sampe name
...
# # Add rectangles
p<- p + annotate("rect", xmin=1, xmax=3, ymin=-0.1 , ymax=-0.05, alpha=0.25, size=0, color="black", fill="black")
# # Add segments
